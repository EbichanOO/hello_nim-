...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/takanori/nimProjects/nimcache/helloWorld.o /home/takanori/nimProjects/nimcache/helloWorld.c */
...
static N_NIMCALL(void, TM_A7knRlN8k9b8juG6Nps9ctmA_3)(void);
...
NimStringDesc* name_zh9c9aW5NGRnJke39cU3PFvwQ;
extern TNimType NTI_77mFvmsOLKik79ci2hXkHEg_;
extern TFrame* framePtr_HRfVMH3jYeBJz6Q6X9b6Ptw;
extern tyObject_GcHeap_1TRH1TZMaVZTnLNcIHuNFQ gch_IcYaEuuWivYAS86vFMTS3Q;
STRING_LITERAL(TM_A7knRlN8k9b8juG6Nps9ctmA_2, "What\'s your name\? ", 18);
STRING_LITERAL(TM_A7knRlN8k9b8juG6Nps9ctmA_4, "Hi, ", 4);
STRING_LITERAL(TM_A7knRlN8k9b8juG6Nps9ctmA_5, "!", 1);
static N_NIMCALL(void, TM_A7knRlN8k9b8juG6Nps9ctmA_3)(void) {
	nimGCvisit((void*)name_zh9c9aW5NGRnJke39cU3PFvwQ, 0);
}
...
nimRegisterGlobalMarker(TM_A7knRlN8k9b8juG6Nps9ctmA_3);
	nimln_(2, "helloWorld.nim");
	printf("%s\012", ((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_2)? (((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_2))->data:"nil");
	fflush(stdout);
	nimln_(3, "helloWorld.nim");
	asgnRefNoCycle((void**) (&name_zh9c9aW5NGRnJke39cU3PFvwQ), readLine_fPRnXwDTqtynUYGl4OixAg(stdin));
	nimln_(4, "helloWorld.nim");
	printf("%s%s%s\012", ((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_4)? (((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_4))->data:"nil", name_zh9c9aW5NGRnJke39cU3PFvwQ? (name_zh9c9aW5NGRnJke39cU3PFvwQ)->data:"nil", ((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_5)? (((NimStringDesc*) &TM_A7knRlN8k9b8juG6Nps9ctmA_5))->data:"nil");
	fflush(stdout);
	popFrame();
}
